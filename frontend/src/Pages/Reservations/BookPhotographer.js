...
const BookPhotographer = () => {
    ...
    const submitBook = (e) => {
        ...
        axios.post(`http://localhost:8080/api/book/booknow`, bookData).then((result) =>{
  ...
  <Form.Group className="mb-3" controlId="formBasicPassword">
    ...
    <Form.Control type="number" placeholder="Number" value={contact} onChange={(e) => setContact(e.target.value)} />
  </Form.Group>
